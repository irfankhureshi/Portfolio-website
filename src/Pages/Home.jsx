    ...
    <div className={`font-sans text-gray-800 ${darkMode ? 'dark bg-gray-900 text-white' : 'bg-linear-to-br from-slate-50 to-blue-50'} min-h-screen transition-colors duration-300 `}>
      ...
      <section id="hero" className={`min-h-screen flex items-center justify-center ${darkMode ? 'bg-linear-to-br from-gray-900 via-gray-800 to-blue-900' : 'bg-linear-to-br from-blue-50 via-white to-purple-50'} pt-20 relative overflow-hidden`}>
        ...
        <div className="text-center px-4 relative z-10 animate-fade-in-up">
          ...
          <h2 className="text-5xl md:text-7xl font-bold mb-6 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
            Hi, I'm Irfan Khureshi <br /> <span className="text-5xl md:text-6xl font-bold">Frontend Developer</span>
          </h2>
      ...
      <section id="about" className="py-24 max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`bg-linear-to-br ${darkMode ? 'from-gray-800 to-gray-700' : 'from-blue-100 to-purple-100'} p-8 rounded-2xl shadow-lg`}>
            <div className="text-center">
              <div className="w-32 h-32 bg-linear-to-r from-blue-500 to-purple-600 rounded-full mx-auto mb-4 flex items-center justify-center">
      ...
      {/* ===== Experience ===== */}
      <section id="experience" className={`py-24 ${darkMode ? 'bg-gray-800' : 'bg-linear-to-br from-gray-50 to-blue-50'}`}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <FaBriefcase className={`text-4xl ${darkMode ? 'text-blue-400' : 'text-blue-500'} mx-auto mb-4`} />
            <h2 className={`text-4xl font-bold mb-6 ${darkMode ? 'bg-linear-to-r from-gray-100 to-gray-300' : 'bg-linear-to-r from-gray-800 to-gray-600'} bg-clip-text text-transparent`}>Experience & Education</h2>
          </div>
      ...
      {/* ===== Skills ===== */}
      <section id="skills" className={`py-24 ${darkMode ? 'bg-gray-900' : 'bg-linear-to-br from-gray-50 to-blue-50'}`}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <FaCode className={`text-4xl ${darkMode ? 'text-blue-400' : 'text-blue-500'} mx-auto mb-4`} />
            <h2 className={`text-4xl font-bold mb-6 ${darkMode ? 'bg-linear-to-r from-gray-100 to-gray-300' : 'bg-linear-to-r from-gray-800 to-gray-600'} bg-clip-text text-transparent`}>Skills & Technologies</h2>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={tool.name}
                  className={`bg-linear-to-r ${tool.color} p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-white text-center font-semibold text-lg`}
                >
                  {tool.name}
                </div>
              ))}
      ...
      <section id="projects" className={`py-24 ${darkMode ? 'bg-gray-800' : ''} max-w-6xl mx-auto px-6`}>
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl font-bold mb-6 ${darkMode ? 'bg-linear-to-r from-gray-100 to-gray-300' : 'bg-linear-to-r from-gray-800 to-gray-600'} bg-clip-text text-transparent`}>Featured Projects</h2>
        </div>
          ...
          {[
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link to={`/project/${project.id}`} className={`${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-500 hover:text-blue-700'} font-medium transition-colors duration-300 group-hover:translate-x-1 transform flex items-center gap-2`}>
      ...
      {/* ===== Testimonials ===== */}
      <section id="testimonials" className={`py-24 ${darkMode ? 'bg-gray-900' : 'bg-linear-to-br from-gray-50 to-blue-50'}`}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <FaStar className={`text-4xl ${darkMode ? 'text-yellow-400' : 'text-yellow-500'} mx-auto mb-4`} />
            <h2 className={`text-4xl font-bold mb-6 ${darkMode ? 'bg-linear-to-r from-gray-100 to-gray-300' : 'bg-linear-to-r from-gray-800 to-gray-600'} bg-clip-text text-transparent`}>What Clients Say</h2>
          </div>
            ...
            {[
              ...
              <div key={index} className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105`}>
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-linear-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold mr-4">
                    {testimonial.avatar}
                  </div>
                  <div>
      ...
      {/* ===== Contact ===== */}
      <section id="contact" className={`py-24 ${darkMode ? 'bg-gray-800' : 'bg-linear-to-br from-blue-50 to-purple-50'}`}>
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <FaEnvelope className={`text-4xl ${darkMode ? 'text-blue-400' : 'text-blue-500'} mx-auto mb-4`} />
            <h2 className={`text-4xl font-bold mb-6 ${darkMode ? 'bg-linear-to-r from-gray-100 to-gray-300' : 'bg-linear-to-r from-gray-800 to-gray-600'} bg-clip-text text-transparent`}>Get In Touch</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-4">
                <div className={`${darkMode ? 'bg-gray-700' : 'bg-blue-100'} p-3 rounded-full`}>
                 <Link to='https://github.com/irfankhureshi'> <FaGithub className={`${darkMode ? 'text-blue-400' : 'text-blue-500'} text-xl`} /> </Link>
                </div>
                <div>
                 <Link to='https://github.com/irfankhureshi'> <h3 className={`font-semibold ${darkMode ? 'text-white' : 'text-gray-800'}`}>GitHub</h3> </Link>
                  <Link to='https://github.com/irfankhureshi'> <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>@yourusername</p> </Link>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <div className={`${darkMode ? 'bg-gray-700' : 'bg-blue-100'} p-3 rounded-full`}>
            ...
            <form className={`${darkMode ? 'bg-gray-700' : 'bg-white'} p-8 rounded-2xl shadow-lg space-y-6`}>
              ...
              <button className="w-full bg-linear-to-r from-blue-500 to-purple-600 text-white py-3 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl font-medium">
                Send Message
              </button>
            </form>
          </div>
      ...
      <footer className={`${darkMode ? 'bg-gray-900' : 'bg-gray-900'} text-white py-8 relative`}>
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 bg-linear-to-r from-blue-500 to-purple-600 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50"
